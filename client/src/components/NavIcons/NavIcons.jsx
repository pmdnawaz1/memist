  ...
  return (
    ...
    <div >
      <div className="navIcons border-l-2 border-r-2 border-t-2 bb-none p-3 rounded-md rounded-b-none bg-[#ffe7a6]">
        ...
        <div className="settings-icon" onClick={()=> setSelectedOption((opt)=> {
          if(opt === navOptions.settings)
            return null
          return navOptions.settings
        })}>
          <UilSetting />
        </div>
        <div className="" onClick={()=> setSelectedOption((opt)=> {
          if(opt === navOptions.settings)
            return null
          return navOptions.settings
        })}>
        ...
        <img src={Noti} alt="" onClick={() => setSelectedOption((opt)=>{
          if(opt === navOptions.notifications)
            return null
